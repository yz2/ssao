...
function get_edge_style() {
    if ((navigator.userAgent.indexOf("Opera") || navigator.userAgent.indexOf('OPR')) != -1) {
        return '-o-crisp-edges';
    } else if (navigator.userAgent.indexOf("Chrome") != -1) {
        return 'pixelated';
    } else if (navigator.userAgent.indexOf("Safari") != -1) {
        return '-webkit-optimize-contrast';
...
$(function($){
  ...
  $.fn.okzoom = function(options){
    ...
    return this.each(function(){
      ...
      // Modification for CS184: remove anti-aliasing
      base.$loupe = $(base.loupe).addClass('ok-loupec').css({
        'image-rendering': get_edge_style(),
  ...
  $.fn.okzoom.mousemove = function (base, e) {
    ...
    base.loupe.style.top = pageY - offsetTop - 1.15*(base.options.height/2) + "px";
