...
import vertexShaderSource from '../../shaders/cryEngineSSAO/diffuse-vert.js';
import fragmentShaderSource from '../../shaders/cryEngineSSAO/cryEngineSSAO-frag.js';
...
function prepareUniforms(renderer) {
	...
	for (var i = 0; i < numSamples; i++) {
		var newSample;
		do {
	    	newSample = [Math.random() * 2.0 - 1.0, Math.random() * 2.0 - 1.0, Math.random()];
	...
	basicRenderer.uniforms['samples'] = {
	    t: 'v3v',
	    value: samples
	};
}

var basicRenderer = new Renderer("SCECanvas");
